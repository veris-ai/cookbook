...
class Card(BaseModel):
    ...
    Replacement is modeled operationally (API creates a new Card and cancels
    the old one). No separate replacement entity is stored.
    """
...
class BCSAPI(BaseModel):
    ...
    def request_card_replacement(self, card_id: str) -> Card:
        ...
        self.db.add_card_to_user(old["user_id"], new_id)
        return successor
