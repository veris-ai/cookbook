...
class RetailTools(ToolKitBase):  # Tools
    ...
    def exchange_delivered_order_items(
        ...
        Args:
            ...
            payment_method_id: The single payment method id to pay or receive refund for the item price difference,
                             such as 'gift_card_0000000' or 'credit_card_0000000'. These can be looked up
                             from the user or order details. Only ONE payment method is accepted per call —
    ...
    def modify_pending_order_items(
        ...
        Args:
            ...
            payment_method_id: The single payment method id to pay or receive refund for the item price difference, such as 'gift_card_0000000' or 'credit_card_0000000'. These can be looked up from the user or order details. Only ONE payment method is accepted per call — split payments are not supported.
